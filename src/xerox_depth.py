...
import numpy as np
from hyperparams import height,width,batch_size
...
K=np.array([[725,    0, 620.5],
   ...
   [0,      0,    1]],dtype=float32)
#extrinsics
R1=np.array([-0.6368979 -0.02389242 -0.7705778 -7.061051 -0.01130057 0.9997016 -0.02165645 271.5504 0.7708654 -0.005084978 -0.6369779 -2.342589 0 0 0 1],dtype=float32)
R1=np.reshape(R1,[4,4])
R2=np.array([-0.636937 -0.02383346 -0.7705474 -7.143026 -0.01146302 0.9997043 -0.02144605 271.5473 0.7708306 -0.004826983 -0.6370219 -2.636987 0 0 0 1],dtype=float32)
R2=np.reshape(R2,[4,4])
P1=K*R1[0:3,:]
P2=K*R2[0:3,:]
